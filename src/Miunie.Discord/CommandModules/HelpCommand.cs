...
namespace Miunie.Discord.CommandModules
{
    ...
    public class HelpCommand : ModuleBase<SocketCommandContext>
    {
        ...
        [Command("help at")]
        [Summary("Gets help for a command at the specified page.")]
        [Examples("help repo")]
        public async Task GetHelp(int page, [Remainder]string input)
        {
            page -= 1;
            var helpResult = _helpProvider.FromInput(input);
            _ = await Context.Channel.SendMessageAsync(embed: EmbedConstructor.CreateHelpEmbed(helpResult, page));
        }
    }
}
